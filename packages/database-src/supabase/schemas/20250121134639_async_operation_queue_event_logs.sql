DROP TABLE IF EXISTS fsm_core.fsm_async_operation_queue_event_logs;
create table fsm_core.fsm_async_operation_queue_event_logs (
    async_operation_queue_event_log_id uuid not null primary key default gen_random_uuid(),
