...
//
// Same wire protocol (protocol.go, ported from the gateway's
// sidecar/protocol.ts), same ActorKey() identity, same register -> heartbeat
// -> serve lifecycle as the TypeScript/Python/Rust versions. Plain blocking
// net.Conn + a goroutine for heartbeats (stdlib only) — the natural Go shape
