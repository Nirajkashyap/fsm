...
//! client (packages/fsm-proto-codegen/gen/rust/, from
//! proto/pgfsm/sidecargateway/v1/sidecar_gateway.proto — see #100),
//! registers a compiled-in actor registry, and serves invoke requests.
//!
...
//! the Rust analogue of sdk.ts's push-based AsyncQueue and sdk.py's
...
use crate::sidecar_gateway::sidecar_gateway_service_client::SidecarGatewayServiceClient;
use crate::sidecar_gateway::{
