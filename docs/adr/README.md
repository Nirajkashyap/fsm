...
| [ADR-002](adr-002-fsm-sync-operation-worker-execution-model.md)          | FSM Worker Execution Model Evolution (Stages 1–3) — covers process model and dispatch strategy                    | Current (Stage 3 active)                                                |
| [ADR-003](adr-003-fsm-async-operation-polyglot-actor-execution-model.md) | Polyglot Actor Execution Model — activity-tier architecture & compiled-language IPC (supersedes KB-001, SPEC-001) | Architecture: Current. IPC decision: Decided, not yet implemented (#55) |
